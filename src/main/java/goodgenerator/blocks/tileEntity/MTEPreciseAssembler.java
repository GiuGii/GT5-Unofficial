...
public class MTEPreciseAssembler extends MTEExtendedPowerMultiBlockBase<MTEPreciseAssembler>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType("Precise Assembler, Assembler, PrAss")
            ...
            .addInfo("Machine Casing Tier determines Maximum Recipe Tier")
            .addSeparator()
            ...
            .addInputHatch("Any Precise Casing")
            .addInputBus("Any Precise Casing")
            .addOutputHatch("Any Precise Casing")
            .addOutputBus("Any Precise Casing")
            .addEnergyHatch("Any Precise Casing")
            .addMufflerHatch("Any Precise Casing")
            .addMaintenanceHatch("Any Precise Casing")
